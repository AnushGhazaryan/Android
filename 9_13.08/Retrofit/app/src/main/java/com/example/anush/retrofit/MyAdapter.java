...
public class MyAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public MyAdapter(List<ModelUser> list, Context context) {
        ...
        switch (viewType) {
            case TYPE_FEMALE:
                View femaleView = LayoutInflater
                        ...
                        .inflate(R.layout.female, parent, false);
                holder = new FemaleViewHolder(femaleView);
                break;
            case TYPE_MALE:
                View maleView = LayoutInflater
                        .from(parent.getContext())
                        .inflate(R.layout.male, parent, false);
    ...
    private void startActivity(int position) {
        ...
        ModelUser.Location location = userList.get(position).getLocation();
    ...
    public class FemaleViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        @Override
        public void onClick(View view) {
            ModelUser user = userList.get(getAdapterPosition());
            switch (view.getId()) {
                case R.id.btn_call:
